  ...
  return (
    ...
    >
      <div className={'mapcard__header'}>
        <div className={'mapcard__title'}>
          {props.title}
        </div>
      </div>
      <div className={'mapcard__location'}>
      <div className={'mapcard__location-meta'}>
        <div className={'mapcard__location-header'}><div className='__icon'>{Tools.renderIcon('van')}</div></div>
        <div className={'mapcard__location-place'}>{props.departing.name}</div>
      </div>
      <div className={'mapcard__location-meta t-right'}>
        <div className={'mapcard__location-header'}><div className='__icon'>{Tools.renderIcon('board')}</div></div>
        <div className={'mapcard__location-place'}>{props.destination.name}</div>
      </div>
      </div>
      ...
      <div className={'mapcard__count'}>
        ...
        <div className={'mapcard__location-date'}>{dateDeparture.format('MMM Do')}</div>
      </div>
      </div>
    </MapCard>
  );
...
export default connect(
  mapStateToProps,
  dispatch => mapDispatchToProps(dispatch, [ tripActions ])
