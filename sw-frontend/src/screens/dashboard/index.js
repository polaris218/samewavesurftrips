...
const DashboardScreen = props => {
    ...
    const startSpring = { opacity: 0, transform:'translate3d(0,200px,0) scale(0.9)' };
    const springProps = useSpring({
      from: startSpring,
      to: initalDisplay ? startSpring : { opacity: 1, transform:'translate3d(0,0,0) scale(1)' },
      reset: true,
    })
...
export default connect(
  mapStateToProps,
  dispatch => mapDispatchToProps(dispatch, [ userActions, tripActions ])
